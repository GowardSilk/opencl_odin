...
Get_Device_Info_Type              :: #type proc(this: ^Emulator, param_name: cl.Device_Info, param_value_size: c.size_t, param_value: rawptr, param_value_size_ret: ^c.size_t) -> cl.Int;
Get_Program_Build_Info_Type       :: #type proc(this: ^Emulator, param_name: cl.Program_Build_Info, param_value_size: c.size_t, param_value: rawptr, param_value_size_ret: ^c.size_t) -> cl.Int;
Get_Kernel_Work_Group_Info_Type   :: #type proc(this: ^Emulator, kernel: Kernel, param_name: cl.Kernel_Work_Group_Info, param_value_size: c.size_t, param_value: rawptr, param_value_size_ret: ^c.size_t) -> cl.Int;
...
Create_Buffer_Type                :: #type proc(this: ^Emulator, flags: cl.Mem_Flags, size: c.size_t, host_ptr: rawptr, errcode_ret: ^cl.Int) -> Mem;
...
Release_Program_Type              :: #type proc(this: ^Emulator) -> cl.Int;
...
Enqueue_NDRange_Kernel_Type       :: #type proc(this: ^Emulator, kernel: Kernel, work_dim: cl.Uint, global_work_offset: ^c.size_t, global_work_size: ^c.size_t, local_work_size: ^c.size_t, num_events_in_wait_list: cl.Uint, event_wait_list: ^cl.Event, event: ^cl.Event) -> cl.Int;
...
CreateBufferEx :: proc "system" (this: ^Emulator, _context: Context, flags: cl.Mem_Flags, host_ptr: ^$T) -> Maybe(Mem) {
	switch this.kind {
		case .Full: return CreateBufferEx_FullCL(this, _context, flags, host_ptr);
		case .Null: return CreateBufferEx_NullCL(this, _context, flags, host_ptr);
	}
	unreachable();
}
CreateBufferEx_NullCL :: proc "system" (this: ^Emulator, _context: Context, flags: cl.Mem_Flags, host_ptr: ^$T) -> Maybe(Mem) {
	unimplemented();
}
CreateBufferEx_FullCL :: proc "system" (this: ^Emulator, _context: Context, flags: cl.Mem_Flags, host_ptr: ^$T) -> Maybe(Mem) {
	ret: cl.Int;
	buf: Mem_Full;
	when intrinsics.type_is_slice(T) || intrinsics.type_is_dynamic_array(T) {
		buf = cl.CreateBuffer(cast(Context_Full)_context, flags, size_of(host_ptr[0]) * len(host_ptr^), raw_data(host_ptr^), &ret);
...
Command_Queue_Property_Null :: enum {
	QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE = 1,
	QUEUE_PROFILING_ENABLE = 2,
	QUEUE_ON_DEVICE = 5, // needs QUEUE_OUT_OF_RDER_EXEC_MODE_ENABLE
	CL_QUEUE_ON_DEVICE_DEFAULT = 13, // needs QUEUE_ON_DEVICE_DEFAULT
}
Command_Queue_Properties_Null :: bit_set[Command_Queue_Property_Null];
...
@(private="file")
GetDeviceInfo_FullCL :: proc(this: ^Emulator, param_name: cl.Device_Info, param_value_size: c.size_t, param_value: rawptr, param_value_size_ret: ^c.size_t) -> cl.Int {
	return cl.GetDeviceInfo(cast(Device_ID_Full)this.ocl.device, param_name, param_value_size, param_value, param_value_size_ret);
}
@(private="file")
GetDeviceInfo_NullCL :: proc(this: ^Emulator, param_name: cl.Device_Info, param_value_size: c.size_t, param_value: rawptr, param_value_size_ret: ^c.size_t) -> cl.Int {
	unimplemented();
}

@(private="file")
GetProgramBuildInfo_FullCL :: proc(this: ^Emulator, param_name: cl.Program_Build_Info, param_value_size: c.size_t, param_value: rawptr, param_value_size_ret: ^c.size_t) -> cl.Int {
	return cl.GetProgramBuildInfo(cast(Program_Full)this.ocl.program, cast(Device_ID_Full)this.ocl.device, param_name, param_value_size, param_value, param_value_size_ret);
}
@(private="file")
GetProgramBuildInfo_NullCL :: proc(this: ^Emulator, param_name: cl.Program_Build_Info, param_value_size: c.size_t, param_value: rawptr, param_value_size_ret: ^c.size_t) -> cl.Int {
	unimplemented();
}

@(private="file")
GetKernelWorkGroupInfo_FullCL :: proc(this: ^Emulator, kernel: Kernel, param_name: cl.Kernel_Work_Group_Info, param_value_size: c.size_t, param_value: rawptr, param_value_size_ret: ^c.size_t) -> cl.Int {
	return cl.GetKernelWorkGroupInfo(cast(Kernel_Full)kernel, cast(Device_ID_Full)this.ocl.device, param_name, param_value_size, param_value, param_value_size_ret);
}
@(private="file")
GetKernelWorkGroupInfo_NullCL :: proc(this: ^Emulator, kernel: Kernel, param_name: cl.Kernel_Work_Group_Info, param_value_size: c.size_t, param_value: rawptr, param_value_size_ret: ^c.size_t) -> cl.Int {
	unimplemented();
}
...
@(private="file")
CreateBuffer_FullCL :: proc(this: ^Emulator, flags: cl.Mem_Flags, size: c.size_t, host_ptr: rawptr, errcode_ret: ^cl.Int) -> Mem {
	return cast(Mem)cl.CreateBuffer(cast(Context_Full)this.ocl._context, flags, size, host_ptr, errcode_ret);
}
@(private="file")
CreateBuffer_NullCL :: proc(this: ^Emulator, flags: cl.Mem_Flags, size: c.size_t, host_ptr: rawptr, errcode_ret: ^cl.Int) -> Mem {
	unimplemented();
}
...
@(private="file")
GetProgramInfo_FullCL :: proc(this: ^Emulator, param_name: cl.Program_Info, param_value_size: c.size_t, param_value: rawptr, param_value_size_ret: ^c.size_t) {
	unimplemented();
}
@(private="file")
GetProgramInfo_NullCL :: proc(this: ^Emulator, param_name: cl.Program_Info, param_value_size: c.size_t, param_value: rawptr, param_value_size_ret: ^c.size_t) {
	unimplemented();
}

@(private="file")
ReleaseProgram_FullCL :: proc(this: ^Emulator) -> cl.Int {
	unimplemented();
}
@(private="file")
ReleaseProgram_NullCL :: proc(this: ^Emulator) -> cl.Int {
	unimplemented();
}
...
@(private="file")
EnqueueNDRangeKernel_FullCL :: proc(this: ^Emulator, kernel: Kernel, work_dim: cl.Uint, global_work_offset: ^c.size_t, global_work_size: ^c.size_t, local_work_size: ^c.size_t, num_events_in_wait_list: cl.Uint, event_wait_list: ^cl.Event, event: ^cl.Event) -> cl.Int {
	return cl.EnqueueNDRangeKernel(cast(Command_Queue_Full)this.ocl.queue, cast(Kernel_Full)kernel, work_dim, global_work_offset, global_work_size, local_work_size, num_events_in_wait_list, event_wait_list, event);
}
@(private="file")
EnqueueNDRangeKernel_NullCL :: proc(this: ^Emulator, kernel: Kernel, work_dim: cl.Uint, global_work_offset: ^c.size_t, global_work_size: ^c.size_t, local_work_size: ^c.size_t, num_events_in_wait_list: cl.Uint, event_wait_list: ^cl.Event, event: ^cl.Event) -> cl.Int {
	unimplemented();
}
...
EnqueueNDRangeKernelEx_FullCL :: proc(this: ^Emulator, kernel: Kernel, work_dim: cl.Uint, global_work_offset: ^c.size_t = nil, global_work_size: ^c.size_t = nil, local_work_size: ^c.size_t = nil) -> cl.Int {
	return this->EnqueueNDRangeKernel(kernel, work_dim, global_work_offset, global_work_size, local_work_size, 0, nil, nil);
}
@(private="file")
